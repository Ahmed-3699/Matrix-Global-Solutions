            ...
            <div className='h-max w-full bg-[rgb(255,237,230)] pt-20'>
                ...
                <div className='h-max sm:w-[95%] w-[90%] grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 m-auto gap-16'>
                    ...
                    <div className='h-max flex flex-col sm:items-start items-center'>
                        ...
                        <ul className='mt-6 flex flex-col gap-2'>
                            <Link to={"/"}>
                                <li className='sm:text-start text-center text-[rgb(254,49,49)] duration-200 cursor-pointer'>Home</li>
                            </Link>
                            <Link to={'/about'}>
                                <li className='text-[rgb(58,58,58)] sm:text-start text-center hover:text-[rgb(254,49,49)] duration-200 cursor-pointer'>About</li>
                            </Link>
                            <Link to={"/career"}>
