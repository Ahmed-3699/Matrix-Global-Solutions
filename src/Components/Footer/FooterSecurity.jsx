    ...
    <div className='h-max flex flex-col md:items-start items-center'>
        ...
        <ul className='mt-6 flex flex-col gap-2'>
            ...
            <Link to={"/home-security"}>
                <li className=' md:text-start  text-center text-[rgb(254,49,49)] duration-200 cursor-pointer'>Home Security</li>
            </Link>
            <Link to={"/taxi-dispatch"}>
                <li className=' md:text-start text-[rgb(58,58,58)] text-center hover:text-[rgb(254,49,49)] duration-200 cursor-pointer'>Taxi Dispatch Services</li>
            </Link>
