                ...
                <div className='h-max sm:w-[95%] w-[90%] grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 m-auto gap-16'>
                    ...
                    <div className='h-max flex flex-col md:items-start items-center'>
                        ...
                        <ul className='mt-6 flex flex-col gap-2'>
                            ...
                            <li className='text-[rgb(58,58,58)] md:text-start text-center hover:text-[rgb(254,49,49)] duration-200 cursor-pointer'>Contact Center as a Service</li>
                            </Link>
                            <Link to={"/offshore-talent-pool"}>
                            <li className='text-[rgb(58,58,58)] md:text-start text-center hover:text-[rgb(254,49,49)] duration-200 cursor-pointer'>Offshore Talent Pool</li>
                            </Link>
                            ...
                            <li className='text-[rgb(58,58,58)] md:text-start text-center hover:text-[rgb(254,49,49)] duration-200 cursor-pointer'>Taxi Dispatch Services</li>
                            </Link>
                            <Link to={"/dispatch-order-management"}>
                            <li className='text-[rgb(58,58,58)] md:text-start text-center hover:text-[rgb(254,49,49)] duration-200 cursor-pointer'>Dispatch Order Management</li>
                            </Link>
                        </ul>
                    </div>
                    ...
                    <div className='h-max flex flex-col sm:items-start items-center'>
                        ...
                        <ul className='mt-6 flex flex-col gap-2'>
                            ...
                            <Link to={"/career"}>
                                <li className='sm:text-start text-[rgb(58,58,58)] text-center hovertext-[rgb(254,49,49)] duration-200 cursor-pointer'>Career</li>
                            </Link>
                            <Link to={"/contact"}>
                                <li className='sm:text-start text-center text-[rgb(58,58,58)] hover:text-[rgb(254,49,49)] duration-200 cursor-pointer'>Contact</li>
                            </Link>
                            <Link to={"/privacy-policy"}>
                                <li className=' sm:text-start text-center text-[rgb(58,58,58)] hover:text-[rgb(254,49,49)] duration-200 cursor-pointer'>Privacy Policy</li>
                            </Link>
                            <Link to={"/term-of-use"}>
                                <li className='sm:text-start text-center text-[rgb(254,49,49)] duration-200 cursor-pointer'>Term of Use</li>
                            </Link>
                        </ul>
                    </div>
...
export default FooterTermOfUse