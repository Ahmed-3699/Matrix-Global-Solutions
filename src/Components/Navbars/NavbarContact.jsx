...
const NavbarContact = () => {
    ...
    return (
        <>
            <div className="h-max w-full bg-white sm:mb-12 mb-5 z-50 relative">
                    ...
                    <div className='links-container h-0 transition-[.24s] lg:bg-transparent bg-white lg:overflow-visible overflow-hidden z-10' ref={linksContainerRef}>
                        <ul className='links relative -mt-3 w-full flex lg:gap-12 gap-8 lg:pl-0 sm:pl-10 pl-4 lg:flex-row lg:items-center  font-medium flex-col lg:text-white  text-black text-[17px]' ref={linksRef}>
                            ...
                            <Link to={'/about'}>
                                ...
                                <li className='cursor-pointer h-max w-max relative flex items-center group justify-center  lg:gap-1 gap-3 text-[rgb(15,23,42)] text-lg hover:text-[rgb(259,49,49)] duration-200'><Link to={"/services"}>Services</Link> <FaAngleDown className='mt-1 w-max' />
                            ...
                            <Link to={"/career"}>
                                <li className='cursor-pointer text-[rgb(15,23,42)] h-max w-max text-lg hover:text-[rgb(254,49,49)] duration-200'>Career</li>
                            </Link>
