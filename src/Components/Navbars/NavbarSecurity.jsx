        ...
        <li className='cursor-pointer h-max w-max relative flex items-center group justify-center  lg:gap-1 gap-3 text-lg text-[rgb(254,49,49)] duration-200'><Link to={"/services"}>Services</Link> <FaAngleDown className='mt-1 w-max' />
          ...
          <div className='absolute lg:top-10 lg:left-0 -top-20 z-50 left-16 overflow-hidden bg-white h-[0px] w-[0px] duration-300 invisible group-hover:visible group-hover:h-[270px] group-hover:w-[240px] shadow-md shadow-black flex flex-col justify-center'>
            ...
            <div className='h-max py-3 px-2'>
              ...
              <p className='duration-150  ml-3 text-[rgb(254,49,49)] leading-6 font-normal text-[16px] text-nowrap'>HOME SECURITY SOLUTIONS</p>
                </Link>
            </div>
            <div className='h-max py-3 px-2'>
              <Link to={"/taxi-dispatch"}>
                <p className='duration-150 ml-3 text-black hover:text-[rgb(254,49,49)] leading-6 font-normal text-[16px] text-nowrap'>TAXI DISPATCH SERVICES</p>
              </Link>
            </div>
            <div className='h-max py-3 px-2'>
